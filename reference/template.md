...
#>  folder  /tmp/Rtmpr7adMJ/POST/WRF/WRF-only : link wrf output files here!
#>  bash  /tmp/Rtmpr7adMJ/POST/post-R_wrf.sh : post processing job script
#>  r-script /tmp/Rtmpr7adMJ/POST/extract_metar.R : source code to extract metar using eva3dm::extract_serie()
#>  r-script /tmp/Rtmpr7adMJ/POST/extract_inmet.R : source code to extract inmet using eva3dm::extract_serie()
```
